<article id="post-<?php the_ID(); ?>">
	...
	<?php else : ?>
		...
		<!--  Tailwind classes to remove opacity from the background -->
		<!--  fixed left-0 top-0 w-full h-screen bg-black bg-opacity-30 -->

		<div class="homepage-content min-h-screen">
