...
<body <?php body_class('text-gray-100 antialiased'); ?>>
	...
	<div id="page" class="min-h-screen flex flex-col">
		...
		<header class="sticky top-0 lg:bg-black lg:bg-opacity-80 lg:w-full'">
		<div class="w-full flex justify-center">
			<?php
		wp_nav_menu( array(
    		'theme_location'  => 'secondary',
    		'container_class' => 'lg:w-full', // Tailwind styles for container
 		    ...
 		    'a_class'         => 'lg:text-2xl lg:tracking-wide lg:font-teko lg:z-20 lg:w-full lg:font-medium lg:uppercase lg:relative',
 		    'submenu_class'   => 'hover-background-animation', // Centered and increased size
));?>
</div>
			<div class="lg:hidden container mx-auto bg-black bg-opacity-80">
				<div class="lg:relative lg:flex lg:justify-between lg:items-center">
					...
					wp_nav_menu(
						array(
							...
							'a_class'         => 'relative inline-block font-teko lg:font-light lg:text-4xl xl:text-7xl uppercase transition-all duration-150', // Class for <a>
							'fallback_cb'     => false,
						)
					);
					?>
