...
wp_nav_menu( array(
    ...
    'li_class'        => 'align-top group relative py-3 px-5 hover:bg-gray-300 hover:text-black hover:decoration-black group-hover:bg-gray-300 text-white transition-all duration-100', // Parent item styles
